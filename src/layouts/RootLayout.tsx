...
const RootLayout = () => {
  const { isSidebarOpen, showCategoryPanel, setAuthenticatedUser,authenticatedUser } = useUIContext();
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1">
        {route === "signIn" || route === "signUp" || route === "confirmSignUp" ? null : <Navbar authenticatedUser={authenticatedUser} />}
